    ...
    <>
      <div className="col-md-5 col-sm-12 col-xs-12">
        <div className="article_bg">
          ...
          <h4 className="post_article">{userInfo.name}</h4>
          ...
          >
            <span className="following">111 Following</span> &nbsp;&nbsp;
            <span className="followers">178 followers</span>
          </p>
          <div className="lit_pink_article ">
            <a href="/profileEdit" className="article_p">
        ...
        <div className="dashboard">
          <h3 className="dash_h3">
            {" "}
            My Dashboard <span className="dash_span">Private to you</span>
          </h3>
        ...
        <div className="dashboard">
          <h3 className="dash_h3">
            {" "}
            Activity <span className="dash_span">400 Followers</span>
          </h3>
            ...
            <div className="col-md-4">
              <div className="media">
                <div className="media-left">
                  <img
                    src="images/blog_dash.png"
                    className="media-object"
                    style={{ width: "60px" }}
                  />
                </div>
                <div className="media-body">
                  <h6 className="media-heading dash_media">
                    {" "}
                    Lol good one Commented 8 hrs{" "}
                  </h6>
                </div>
              </div>
            </div>
        ...
        <div className="dashboard">
          <h3 className="dash_h3">
            {" "}
            Experience <span className="dash_span">4+ Years</span>
          </h3>
          <div className="row">
            <div className="col-md-10">
              <div className="media">
                ...
                <div className="media-body">
                  ...
                  <h6 className="media-heading dash_media">
                    {" "}
                    Lol good one Commented 8 hrsLol good one Commented 8 hrsLol
                    good one Commented 8 hrs{" "}
                  </h6>
                </div>
              </div>
              <br />
            ...
            <div className="col-md-2">
              <a href="#" className="edit_clr">
                <i className="fa fa-plus-circle"></i>
              </a>
              <br />
              <a href="#" className="pencil_edit">
          ...
          <div className="row">
            ...
            <div className="col-md-2">
              <a href="#" className="see_more pull-right">
                See More
              </a>
            </div>
          </div>
        ...
        <div className="dashboard">
          ...
          <div className="row">
            <div className="col-md-10">
              <p className="skills">
                <i className="fa fa-genderless tick_mark"></i> &nbsp; Adobe
                Illustrator
              </p>
              <p className="skills">
                {" "}
                <i className="fa fa-genderless tick_mark"></i> &nbsp; 2012 –
                2014{" "}
              </p>
              <p className="skills">
                {" "}
                <i className="fa fa-genderless tick_mark"></i> &nbsp;Adobe after
                effect{" "}
              </p>
              <p className="skills">
                {" "}
                <i className="fa fa-genderless tick_mark"></i> &nbsp;2012 – 2014{" "}
              </p>
              <p className="skills">
                {" "}
                <i className="fa fa-genderless tick_mark"></i> &nbsp; KIIT
                UNIVERSITY{" "}
              </p>
              <p className="skills">
                {" "}
          ...
          <div className="row">
            <div className="col-md-4">
              <div className="media">
                <div className="media-left">
                  <img
                    src="images/intrest.png"
                    className="media-object exp"
                    style={{ width: "60px" }}
                  />
                </div>
                <div className="media-body">
